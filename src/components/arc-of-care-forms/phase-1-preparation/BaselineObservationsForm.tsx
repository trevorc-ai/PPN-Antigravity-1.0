                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full px-4 py-2.5 rounded-xl text-sm font-semibold text-left transition-all active:scale-95 ${isSelected
                                                ? 'bg-indigo-600 text-[#A8B5D1] shadow-lg shadow-indigo-600/30 border border-indigo-500'
                                                : 'bg-slate-800/60 text-slate-300 border border-slate-700/50 hover:border-slate-500 hover:text-[#A8B5D1]'
                                                }`}
                                        >
                                            {obs.label}
                                        </button>
