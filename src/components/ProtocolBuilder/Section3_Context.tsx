      ...
      <div className="space-y-4">
        <div className="flex gap-4 p-4 rounded-xl bg-slate-800/20 border border-slate-700 hover:border-slate-500 transition-colors">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">Standardized playlists for emotional peaks.</p>
          </div>
        </div>
        ...
        <div className="flex gap-4 p-4 rounded-xl bg-slate-800/20 border border-slate-700 hover:border-slate-500 transition-colors">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">Touch therapy available on request.</p>
          </div>
        </div>
        ...
        <div className="flex gap-4 p-4 rounded-xl bg-slate-800/20 border border-slate-700 hover:border-slate-500 transition-colors">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">Required for high-dose sessions.</p>
          </div>
        </div>
      </div>
    </div>
