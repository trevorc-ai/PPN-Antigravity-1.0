    ...
    questions: [
        {
            ...
            subscale: 'Fear',
            tooltip: 'Tracks anxiety or panic during the session.',
            citation: 'Barrett et al., 2016',
            type: 'likert',
            min: 0,
            max: 5,
            labels: [
        ...
        },
        {
            ...
            subscale: 'Grief',
            tooltip: 'Measures emotional processing of loss or sadness.',
            citation: 'Barrett et al., 2016',
            type: 'likert',
            min: 0,
            max: 5,
        ...
        },
        {
            ...
            tooltip: 'Assesses somatic discomfort or nausea.',
            citation: 'Barrett et al., 2016',
            type: 'likert',
            min: 0,
            max: 5,
