    ...
    return (
        <div className="min-h-screen bg-[#0a1628] px-4 py-4 sm:px-8 sm:py-6 lg:px-16 lg:py-8 xl:px-24">
            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                {/* ── Phase Tabs + Panel (connected tab UI) ─────────────────────── */}
                <div className="flex flex-col">
                    {/* Tab row — sits flush on top of the panel */}
                    <PhaseIndicator
                    ...
                    {/* Panel — shares border with the active tab's bottom edge */}
                    <div
                        id={`phase-panel-${activePhase}`}
                        role="tabpanel"
                        aria-labelledby={`phase-tab-${activePhase}`}
                        className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-b-2xl rounded-tr-2xl p-6 space-y-6 relative z-0"
                    >
                        {/* Phase lock notice — inside panel, not a floating chip */}
                        ...
                        {/* Benchmark + Risk — only after all Phase 1 forms done */}
