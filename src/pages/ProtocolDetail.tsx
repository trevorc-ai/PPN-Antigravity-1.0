...
const ProtocolDetail: React.FC = () => {
      ...
      <div className="min-h-full bg-[#020408] flex items-center justify-center animate-in fade-in duration-500">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-3">
            <h2 className="text-3xl font-black text-slate-100 uppercase tracking-widest leading-none">Record Not Found</h2>
  ...
  return (
    <div className="min-h-full bg-[#020408] text-slate-100 p-4 sm:p-8 animate-in fade-in duration-700 relative overflow-hidden print:bg-white print:text-black print:p-0 print:overflow-visible font-sans">
      ...
      <PageContainer width="wide" className="space-y-8 relative z-10">
        ...
        <div className="flex justify-between items-center print:hidden">
          ...
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-4 py-2 border border-slate-700 hover:bg-slate-800 text-slate-300 hover:text-white rounded-lg transition-all text-xs font-black uppercase tracking-widest"
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                <div className="md:col-span-1 space-y-4">
                  <p className="text-sm font-bold text-slate-400 leading-relaxed print:text-black">
                    <span className="text-white print:text-black">Micro-Pharmacology Analysis:</span> Visualizing the binding potency across critical safety and efficacy targets.
                  </p>
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-center gap-3">
                      ...
                      <span className="text-[11px] font-black text-slate-500 uppercase tracking-widest print:text-black">Standard (Baseline)</span>
                    </li>
                  </ul>
                  <div className="p-4 bg-slate-900/50 border border-slate-800 rounded-2xl mt-4 print:bg-white print:border-black">
                    ...
                    <span className="text-xs font-bold text-white print:text-black">5-HT2A Agonism (Psychedelic)</span>
                  </div>
                </div>
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-3xl space-y-2 print:bg-gray-50 print:border-gray-200">
                    ...
                    <p className="text-xl font-bold text-white print:text-black">{record.context?.setting || 'Not Specified'}</p>
                  </div>
                  <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-3xl space-y-2 print:bg-gray-50 print:border-gray-200">
                    <div className="flex items-center gap-3 text-slate-500 mb-2 print:text-black">
                    ...
                    <p className="text-xl font-bold text-white print:text-black">{record.context?.supportRatio || 'Unsupervised'}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="h-14 w-full flex rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 shadow-inner print:bg-gray-100 print:border-gray-300">
                    {prepHours > 0 && (
                      ...
                      >
                        <span className="text-sm font-black text-white tracking-widest uppercase px-2 whitespace-nowrap print:text-black">
                          {prepHours}h Prep
                        </span>
                      </div>
                    )}
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                ...
                <div className="space-y-6 p-6 bg-slate-900/30 rounded-3xl border border-slate-800 flex flex-col justify-center print:bg-gray-50 print:border-gray-200">
                  ...
                  <div className="pt-4 border-t border-slate-800/50 mt-auto print:border-gray-300">
                    ...
                    <span className="text-base font-bold text-white print:text-black">{record.experience?.resolutionStatus}</span>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-slate-800/50 print:border-gray-300">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold text-white print:text-black">{record.protocol.dosage} {record.protocol.dosageUnit}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold text-slate-500 uppercase tracking-widest print:text-black">Route</span>
                    <span className="text-lg font-bold text-white print:text-black">{record.protocol.route}</span>
                  </div>
                  <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Cohort Matches</h3>
              </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      <span className="text-[11px] font-black text-slate-500 uppercase tracking-widest block">Subject Reference</span>
                      <span className="text-sm font-mono font-black text-white uppercase">{caseItem.demographics.patientHash?.substring(0, 8) || caseItem.id}</span>
                    </div>
