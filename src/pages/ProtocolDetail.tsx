...
const ProtocolDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-full bg-[#0a1628] text-slate-300 p-4 sm:p-8 animate-in fade-in duration-700 relative overflow-hidden print:bg-white print:text-black print:p-0 print:overflow-visible font-sans">
      ...
      <PageContainer width="wide" className="!max-w-[1600px] space-y-8 relative z-10">
        ...
        <div className="flex justify-between items-center print:hidden">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-slate-300 hover:text-slate-300 transition-colors group px-2 py-1"
          >
          ...
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-4 py-2 border border-slate-700 hover:bg-slate-800 text-slate-300 hover:text-slate-300 rounded-lg transition-all text-xs font-black uppercase tracking-widest"
          >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-b border-white/5 pb-8 print:border-black/10">
          <div className="space-y-1">
            <div className="flex items-center gap-4">
              <h1 className="text-4xl font-black tracking-tight print:text-black" style={{ color: '#8BA5D3' }}>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-[#0b0e14] border border-slate-800 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl relative print:bg-white print:border-black/20 print:shadow-none print:rounded-xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  <h3 className="text-xl font-black uppercase tracking-[0.2em] print:text-black" style={{ color: '#A8B5D1' }}>Receptor Affinity Profile</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                <div className="md:col-span-1 space-y-4">
                  <p className="text-sm font-bold leading-relaxed print:text-black" style={{ color: '#8B9DC3' }}>
                    <span className="print:text-black" style={{ color: '#8B9DC3' }}>Micro-Pharmacology Analysis:</span> Visualizing the binding potency across critical safety and efficacy targets.
                  </p>
            ...
            <section className="bg-[#0b0e14] border border-slate-800 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl overflow-hidden relative print:bg-white print:border-black/20 print:shadow-none print:rounded-xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex items-center gap-2">
                  <h3 className="text-xl font-black uppercase tracking-[0.2em] print:text-black" style={{ color: '#A8B5D1' }}>Therapeutic Envelope</h3>
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-3xl space-y-2 print:bg-gray-50 print:border-gray-200">
                    ...
                    <p className="text-xl font-bold print:text-black" style={{ color: '#8B9DC3' }}>{record.context?.supportRatio || 'Unsupervised'}</p>
                  </div>
                </div>
            ...
            <section className="bg-[#0b0e14] border border-slate-800 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl relative print:bg-white print:border-black/20 print:shadow-none print:rounded-xl">
              <div className="flex items-center gap-4 mb-10">
                ...
                <div className="flex items-center gap-2">
                  <h3 className="text-xl font-black uppercase tracking-[0.2em] print:text-black" style={{ color: '#A8B5D1' }}>EFFICACY TRAJECTORY (PHQ-9)</h3>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                ...
                <div className="space-y-6 p-6 bg-slate-900/30 rounded-3xl border border-slate-800 flex flex-col justify-center print:bg-gray-50 print:border-gray-200">
                  ...
                  <div className="pt-4 border-t border-slate-800/50 mt-auto print:border-gray-300">
                    <span className="text-xs font-bold text-slate-300 block mb-1 uppercase tracking-widest print:text-black">Status</span>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <section className="bg-[#0b0e14] border border-slate-800 rounded-[2.5rem] p-8 shadow-2xl print:bg-white print:border-black/20 print:shadow-none print:rounded-xl print:break-inside-avoid">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-3xl font-black tracking-tight print:text-black" style={{ color: '#9DAEC8' }}>{record.protocol.substance}</p>
                </div>
                ...
                <div className="pt-6 border-t border-slate-800/50 print:border-gray-300">
                  ...
                  <div className="p-4 bg-black border border-slate-800 rounded-xl font-mono text-xs text-slate-300 break-all leading-relaxed print:bg-white print:border-black print:text-black">
            ...
            <section className="bg-[#0b0e14] border border-slate-800 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden print:bg-white print:border-black/20 print:shadow-none print:rounded-xl print:break-inside-avoid">
              ...
              <div className="flex items-center gap-3 mb-8 relative z-10">
                ...
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-black uppercase tracking-widest print:text-black" style={{ color: '#A8B5D1' }}>Safety Monitor</h3>
                  <AdvancedTooltip
                  ...
                  <div className="flex flex-col gap-3">
                    {record.context?.concomitantMeds && record.context.concomitantMeds.length > 0 ? (
                      record.context.concomitantMeds.map((med, i) => (
                        ...
                        >
                          <span className="text-sm font-bold text-slate-300 group-hover:text-red-200 print:text-black">{med}</span>
