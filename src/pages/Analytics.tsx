...
const Analytics = () => {
    ...
    return (
        <PageContainer className="!max-w-7xl space-y-4 sm:space-y-8 animate-in fade-in duration-700 pb-20 pt-4 sm:pt-8 print:p-0 print:space-y-4 print:bg-white">
                    ...
                    {kpiStats.map((stat, i) => (
                        <div key={i} className="bg-[#0a0c12]/50 border border-slate-800/50 p-4 rounded-2xl flex flex-col justify-between print:bg-white print:border-gray-200 print:shadow-none" style={{ minHeight: '100px' }}>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <div className="text-sm font-black text-slate-500 uppercase tracking-widest print:text-slate-500">{stat.label}</div>
                            </div>
                            <div className="flex items-baseline gap-2">
                                <div className={`text-3xl font-black ${stat.color} tracking-tight`}>{stat.value}</div>
                                <div className="text-sm font-bold bg-slate-900/50 px-2 py-0.5 rounded border border-slate-800 print:bg-gray-100 print:text-slate-600 print:border-gray-200" style={{ color: '#8B9DC3' }}>{stat.trend}</div>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="bg-[#0a0c12]/50 border border-slate-800/50 rounded-2xl p-6 print:bg-white print:border-gray-200 print:shadow-none">
                    ...
                    <div className="flex items-center justify-between mb-5">
                        ...
                        {!benchmark && !benchmarkLoading && (
                            <span className="text-sm font-black px-3 py-1.5 rounded-full border bg-indigo-500/10 border-indigo-500/30 text-indigo-400 uppercase tracking-widest">
                                Preview, sample data
                            </span>
                        )}
                    </div>
            ...
            <Section spacing="tight" className="print:hidden">
                <div className="flex flex-col xl:flex-row gap-4 items-stretch xl:items-center bg-[#0a0c12]/80 border border-slate-800/80 p-3 rounded-2xl backdrop-blur-xl shadow-2xl">
                    <div className="flex items-center gap-2 px-2">
                        ...
                        <span className="text-sm font-black uppercase tracking-widest hidden md:block" style={{ color: '#8B9DC3' }}>Chart Filters</span>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col md:flex-row gap-2">
                        <select
                            className="bg-black/40 border border-slate-700/50 text-sm font-bold rounded-lg px-3 py-2 outline-none focus:border-indigo-500/50 uppercase tracking-wider"
                            style={{ color: '#8B9DC3' }}
            ...
            {/* PRINT FOOTER */}
            <div className="hidden print:block text-center text-sm text-slate-400 pt-8 border-t border-gray-200 mt-8">
