    ...
    return (
        <PageContainer className="py-8">
            <Section>
                ...
                {/* ── Tab navigation ──────────────────────────────────────────── */}
                <div className="overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0 mb-8 scrollbar-none">
                    <div className="flex gap-2 min-w-max pb-1" role="tablist" aria-label="Pharmacology views">
                        <button
