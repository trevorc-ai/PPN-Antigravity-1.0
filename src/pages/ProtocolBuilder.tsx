...
export const ProtocolBuilder = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Map smoking_status text label → patient_smoking_status_id FK
    // Mirrors ref_smoking_status (status_code populated migration 069)
    const SMOKING_STATUS_ID: Record<string, number> = {
      'Non-Smoker': 1,         // NON_SMOKER
      'Former': 2,             // FORMER
      'Current Occasional': 3, // CURRENT_OCCASIONAL
      'Current Daily': 4,      // CURRENT_DAILY
    };
