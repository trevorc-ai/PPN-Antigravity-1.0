    ...
    <PageContainer className="p-6 sm:p-10 space-y-10 animate-in fade-in duration-700 max-w-[1600px] mx-auto pb-24">
      ...
      <Section spacing="tight" className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-xs font-black uppercase tracking-[0.3em] ml-1">Institutional Data Contribution // Registry Node 0x7</p>
        </div>
        ...
        <section className="bg-black border border-slate-800 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-6 relative z-10">
            <div className="space-y-1">
              ...
              <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Digital extraction from physical clinical records</p>
            </div>
            ...
            >
              ...
              <button className="px-6 py-2.5 bg-slate-800 hover:bg-slate-700 text-sm font-black text-white rounded-xl uppercase tracking-widest transition-all">
                Select Files
              </button>
            </div>
        ...
        <section className="bg-black border border-slate-800 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-8 relative z-10 h-full flex flex-col">
            <div className="space-y-1">
              ...
              <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Real-time voice-to-protocol synthesis</p>
            </div>
            ...
            <div className="flex gap-3">
              <button className="flex-1 py-4 bg-slate-900 border border-slate-800 rounded-2xl text-sm font-black text-slate-400 uppercase tracking-widest transition-all hover:text-white">
                Input Settings
              </button>
              <button className="flex-1 py-4 bg-primary hover:bg-blue-600 text-white rounded-2xl text-sm font-black uppercase tracking-widest shadow-xl shadow-primary/10 transition-all active:scale-95">
                Review Lexicon
              </button>
            </div>
          </div>
      ...
      <Section spacing="default" className="bg-black border border-slate-800 rounded-[2.5rem] overflow-hidden shadow-2xl backdrop-blur-xl">
        <div className="px-8 py-6 border-b border-slate-800 flex items-center justify-between bg-slate-900/20">
          ...
          <span className="text-[11px] font-mono text-slate-500 uppercase tracking-widest">Sync_ID: 0x77AF</span>
        </div>
              ...
              {pendingJobs.map((job) => (
                <tr key={job.id} className="hover:bg-primary/5 transition-colors group">
                  <td className="px-8 py-5">
                    <span className="text-sm font-mono font-black text-white tracking-tight">{job.id}</span>
                  </td>
                  <td className="px-8 py-5">
                  ...
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-black text-slate-500 uppercase tracking-widest">{job.type}</span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-[11px] font-black uppercase tracking-tighter ${job.status === 'Processing' ? 'text-primary' : 'text-slate-500'}`}>{job.status}</span>
                    </div>
                  </td>
        ...
        <div className="px-8 py-6 bg-slate-900/10 border-t border-slate-800 flex justify-between items-center">
          ...
          <button className="text-sm font-black text-primary hover:text-white uppercase tracking-widest transition-colors flex items-center gap-2">
            View All Jobs
