...
- `BetaWelcome.tsx` (`/beta-welcome`): VIP founding member entry screen. Personalized via `?name=` URL param. Routes to `/analytics`. No auth required. SEO: "PPN Portal - Founding Member Access". Published via GO-585.
