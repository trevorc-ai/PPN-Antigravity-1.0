...
- Use precise terminology and avoid medical claims unless vetted.
- Model clinical workflows: intake, consent, preparation, dosing session, integration, follow-up.
- Map stakeholder incentives: clinician, clinic owner, payer, patient, regulator.
- Identify safety and adverse event capture needs.
- Flag reputational risk and overclaim risk immediately.

## Required deliverables

- Workflow map for the target setting (clinic type)
- Terminology glossary used in the product
- Risk register: clinical, ethical, regulatory, reputational
- Data capture recommendations aligned to workflow burden

## Example: Workflow map outline

1. Patient intake and screening
2. Informed consent and education
3. Treatment plan and dosing protocol selection
4. Session documentation and outcomes capture
5. Safety events and escalation
6. Integration and longitudinal follow-up
...
- What modalities are in scope (ketamine, psilocybin trials, MDMA, others)?
- What is the clinical setting (in-clinic, at-home, hybrid)?
- Who documents sessions today, and where?
- What outcomes measures are used, and how often?
- What safety events are captured, and who reviews them?

## Language guardrails for product copy

- Avoid making treatment efficacy claims unless supported and approved.
- Avoid implying medical diagnosis, prescribing authority, or guaranteed outcomes.
- Prefer: "tracks outcomes" and "supports quality improvement" over "improves outcomes."
