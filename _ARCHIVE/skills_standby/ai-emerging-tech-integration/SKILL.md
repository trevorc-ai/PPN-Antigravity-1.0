...
- Start with use-case selection, not model selection.
- Define the "job to be done" and the workflow step to automate or augment.
- Prefer shipping a thin slice with measurement over building a broad platform.
- For AI video generation: define quality bar, cost per minute, legal rights, and human review steps.
- For data annotation: define schema, label definitions, inter-rater reliability, and audit sampling.
- For machine learning: define target variable, leakage risks, baseline heuristics, and offline vs online evaluation.

## Required deliverables

- AI opportunity backlog ranked by impact, feasibility, and risk
- Data readiness assessment (availability, quality, governance)
- Pilot plan (2 to 4 weeks) with success metrics and stop conditions
- Build vs buy decision memo

## Example: AI opportunity backlog table
...
## AI opportunity backlog template

Fields:
- Opportunity name
- User persona
- Current workflow step
- Pain and cost of delay
- Proposed AI assist
- Human review points
- Data required
- Model approach (heuristic, retrieval, fine-tuned, vendor)
- Build effort (days)
- Ongoing cost (per user, per month)
- Risk (privacy, safety, reputational)
- Success metric
- Stop condition

## Data annotation guide template

Sections:
- Label taxonomy and definitions
- Positive and negative examples
- Edge cases and how to label them
- Required context for labelers
- Quality checks (spot checks, double labeling rate)
- Inter-rater agreement target
- Disagreement resolution process
- Audit sampling plan

## Build vs buy memo template
