...
- Design is decision-making. Tie every design choice to a user goal.
- Reduce cognitive load: fewer choices, clearer states, better defaults.
- Validate with prototypes and user testing, not internal opinions.

## Required deliverables

- Primary user journeys (3 to 5)
- Wireframes or interaction notes per journey
...
## Quick usability test guide

- 5 users, 30 minutes each
- 3 tasks, no coaching, observe friction
- Capture quotes and time to complete
