      ...
      <section className="relative pt-20 pb-12 px-6 sm:px-10 z-10 border-b border-white/5 bg-[#05070a]">
        <div className="max-w-3xl mx-auto flex flex-col items-center text-center space-y-10 relative z-10">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="space-y-1">
              <h1 className="text-4xl sm:text-6xl font-black tracking-tighter text-slate-100 mb-4">PPN Research Portal</h1>
          ...
          <div className="w-full relative group">
            ...
            <div className="relative">
              <div className="absolute left-8 top-1/2 -translate-y-1/2 flex items-center pointer-events-none">
                <span className="material-symbols-outlined text-primary text-2xl animate-pulse mr-2">search</span>
              </div>
              <input
                id="tour-search-node"
                type="text"
                ...
                placeholder="Search protocol ID, substance, or clinical diagnosis..."
                className="w-full h-16 sm:h-24 bg-slate-900/90 border border-slate-700/50 rounded-[2.5rem] px-16 text-lg font-bold text-white focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all backdrop-blur-2xl shadow-2xl placeholder:text-slate-600 text-center"
              />
              <button
                onClick={() => setIsFilterOpen(!isFilterOpen)}
                className={`absolute right-4 top-1/2 -translate-y-1/2 size-12 flex items-center justify-center rounded-full border transition-all ${isFilterOpen ? 'bg-primary border-primary text-white' : 'bg-[#111418] border-slate-800 text-slate-400 hover:border-slate-700'}`}
