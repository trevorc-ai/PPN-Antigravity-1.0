...
const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-slate-100 selection:bg-primary/30 selection:text-white font-sans overflow-x-hidden">
      {/* SECTION: Hero & Neural Map Background */}
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 overflow-hidden">
        {/* Animated Neural Background */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-primary/10 rounded-full blur-[160px] animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-indigo-500/5 rounded-full blur-[140px] animate-pulse" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-10">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-slate-400 max-w-2xl lg:mx-0 mx-auto leading-relaxed font-medium">
                PPN Research Portal is a practitioner-only outcomes registry for psychedelic care. Track outcome change across sessions and compare results to aggregated network benchmarks, built with privacy by design, with no patient names or narrative notes stored.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center lg:justify-start justify-center gap-4 pt-4"
            >
              <button
                onClick={() => navigate('/login')}
                className="px-8 py-4 bg-primary hover:bg-blue-600 text-white text-[12px] font-black rounded-2xl uppercase tracking-[0.2em] transition-all shadow-2xl shadow-primary/20 hover:scale-105 active:scale-95"
              >
                Enter Search Portal
              </button>
              <button
                onClick={() => navigate('/login')}
                className="px-8 py-4 bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 text-[12px] font-black rounded-2xl uppercase tracking-[0.2em] transition-all hover:bg-slate-800"
              >
                Request Access
              </button>
            </motion.div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 auto-rows-[280px]">
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="lg:col-span-8 bg-slate-900/40 border border-white/5 rounded-[3rem] p-10 hover:bg-slate-900/60 transition-all group overflow-hidden relative"
            >
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="lg:col-span-4 bg-indigo-600/10 border border-indigo-500/20 rounded-[3rem] p-10 group hover:shadow-2xl hover:shadow-indigo-500/5 transition-all"
            >
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="lg:col-span-4 bg-red-600/5 border border-red-500/10 rounded-[3rem] p-10 group hover:border-red-500/30 transition-all"
            >
              <div className="h-full flex flex-col justify-between">
                <div className="space-y-4">
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="lg:col-span-8 bg-slate-900/40 border border-white/5 rounded-[3rem] p-10 relative overflow-hidden group"
            >
              <div className="h-full flex flex-col justify-between relative z-10">
                <div className="space-y-2">
      ...
      <section className="py-20 border-y border-slate-800/50 bg-slate-950/50 relative overflow-hidden">
      ...
      {/* SECTION: About PPN */}
      <section className="py-32 px-6 bg-[#07090d] border-b border-slate-900/50">
      ...
      <footer className="py-32 px-6 bg-[#05070a] border-t border-slate-900">
        <div className="max-w-7xl mx-auto space-y-20">
