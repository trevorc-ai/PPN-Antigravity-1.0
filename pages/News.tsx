    ...
    <div className="group bg-[#1c222d]/30 border border-slate-800 rounded-[2rem] overflow-hidden flex flex-col transition-all duration-500 hover:border-primary/50 hover:bg-[#1c222d]/50">
      <div className="h-60 relative overflow-hidden shrink-0">
        ...
        <div className="absolute bottom-4 left-6 flex items-center gap-3">
          <span className={`px-2 py-1 text-[11px] font-black uppercase tracking-widest rounded border ${article.category === 'Regulatory' ? 'bg-primary/20 text-primary border-primary/30' :
              article.category === 'Neuroscience' ? 'text-indigo-400 bg-indigo-400/10 border-indigo-400/20' :
                article.category === 'Clinical' ? 'text-clinical-green bg-clinical-green/10 border-clinical-green/20' : 'text-slate-400 bg-slate-800 border-slate-700'
            }`}>
            {article.category}
          </span>
    ...
    <div className="min-h-full flex flex-col bg-[#0e1117] animate-in fade-in duration-1000">
      <div className="max-w-[1600px] mx-auto w-full flex flex-col lg:flex-row gap-10 p-6 sm:p-10">
        ...
        <div className="flex-1 space-y-8">
          <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tighter">News Feed</h1>
        ...
        <aside className="lg:w-[340px] shrink-0 space-y-10">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-2 text-slate-400">
              ...
              <h3 className="text-[11px] font-black tracking-[0.2em]">Trending Topics</h3>
            </div>
          ...
          <section className="bg-[#1c222d]/30 border border-slate-800 rounded-[2.5rem] p-8 space-y-8">
            <div className="space-y-1">
              <h3 className="text-[11px] font-black text-slate-200 uppercase tracking-[0.2em]">Portal Metrics</h3>
            </div>
          ...
          <div className="p-6 bg-slate-900/40 border border-slate-800/60 rounded-3xl flex items-center gap-5">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[11px] font-mono font-bold text-clinical-green uppercase">Verified Research Node</span>
            </div>
          </div>
        </aside>
      </div>
