...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-full bg-[#05070a] text-slate-100 font-sans animate-in fade-in duration-700 pb-20 overflow-x-hidden">
      {/* Hero Section */}
      <div className="relative py-20 sm:py-32 border-b border-white/5 bg-[#080a0f]">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4 shadow-xl">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-20 space-y-32">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-4">
              <button 
                ...
                className="px-8 py-4 bg-primary hover:bg-blue-600 text-white text-[10px] font-black rounded-2xl uppercase tracking-[0.2em] transition-all shadow-xl shadow-primary/20 active:scale-95"
              >
             ...
             <div className="relative bg-[#111418]/60 border border-slate-800 rounded-[3rem] p-8 sm:p-12 shadow-2xl backdrop-blur-xl">
                <div className="grid grid-cols-2 gap-6">
                   <div className="p-6 bg-black/40 border border-slate-800 rounded-[2rem] space-y-3">
                      ...
                      <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Enrolled Subjects</p>
                   </div>
                   <div className="p-6 bg-black/40 border border-slate-800 rounded-[2rem] space-y-3">
                      <span className="text-3xl font-black text-clinical-green">04</span>
                      <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Global Hubs</p>
                   </div>
                   <div className="p-6 bg-black/40 border border-slate-800 rounded-[2rem] space-y-3">
                      <span className="text-3xl font-black text-primary">85%</span>
                      <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Avg. Outcome Lift</p>
                   </div>
                   <div className="p-6 bg-black/40 border border-slate-800 rounded-[2rem] space-y-3">
        ...
        <div className="space-y-16">
          <div className="text-center space-y-8">
            <h3 className="text-[10px] font-black text-primary tracking-[0.4em] uppercase tracking-[0.8em]">Our Principles</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-slate-900/40 border border-slate-800 p-10 rounded-[2.5rem] space-y-6 hover:bg-slate-900/60 transition-all group">
                ...
                <h4 className="text-xl font-black text-white tracking-tight">{principle.title}</h4>
              ...
              {['Baltimore', 'London', 'Zurich', 'Palo Alto'].map(loc => (
                <div key={loc} className="space-y-2">
                   ...
                   <div className="flex items-center justify-center gap-2">
                      ...
                      <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Active Practitioner</span>
                   </div>
                </div>
              ))}
           </div>
        ...
        <div className="flex flex-col items-center space-y-10 py-10">
           ...
           <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="px-10 py-5 bg-white text-black text-[11px] font-black rounded-2xl uppercase tracking-[0.2em] transition-all hover:bg-slate-200 active:scale-95"
              >
                Login
              </button>
              <button 
                onClick={() => navigate('/help')}
                className="px-10 py-5 bg-transparent border border-slate-800 text-slate-300 text-[11px] font-black rounded-2xl uppercase tracking-[0.2em] transition-all hover:bg-white/5 active:scale-95"
              >
                Inquire for Access
              </button>
           </div>
