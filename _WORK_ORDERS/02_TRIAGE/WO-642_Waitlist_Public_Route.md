...
Run through standard SOOP migration protocol before BUILDER touches frontend code.
...
- [ ] Migration runs cleanly through SOOP protocol
...
**Routing Decision:** SOOP runs migration first. BUILDER implements frontend after migration
