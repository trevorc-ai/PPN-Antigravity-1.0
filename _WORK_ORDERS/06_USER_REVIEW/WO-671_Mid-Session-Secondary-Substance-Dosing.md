...
builder_notes: "Created IbogaineDosingCalculator.tsx (multi-dose log with Ibogaine HCL/TPA enum, real-time cumulative mg/kg calculator, incidental IV medications, dose_sequence tracking). Migration 085 adds cumulative_mg_kg, session_weight_kg, and dose_sequence to log_dose_events."
files:
  - src/components/arc-of-care-forms/phase-2-dosing/IbogaineDosingCalculator.tsx
  - migrations/085_add_cumulative_mgkg_to_log_dose_events.sql
---
