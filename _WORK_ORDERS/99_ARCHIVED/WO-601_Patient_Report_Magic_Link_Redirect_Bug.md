...
builder_notes: "Fixed HashRouter URL format bug in MagicLinkModal (#/journey/auth?token=...&id=...) and PatientReport share functions. Route and Copy Link button were already in place."
---
