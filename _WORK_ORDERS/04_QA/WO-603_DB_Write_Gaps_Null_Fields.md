...
**builder_notes:** All 6 fixes already built in prior sessions. Fix 2 (Set&Setting intention_theme_ids/mindset), Fix 3 (patient profiles upsert), Fix 4 (indications upsert + created_by), Fix 5 (baseline assessment nulls), Fix 6 (performed_by auto-fill). Fix 7 is NO-OP by design.
