...
builder_notes: "Created docs/EPISODE_CONSTRUCTION_RULES.md with 8 episode construction rules + 6 locked standard time windows. Covers episode start/end, 90-day allowable gap, protocol change rule, follow-up attachment, repeated episodes, cross-protocol rules, and minimum validity data requirements."
