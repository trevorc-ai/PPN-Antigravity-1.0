...
- Start with analytics and rules-based automation before ML.
- Use a "model ladder": heuristics, simple models, then more complex models only if needed.
- Treat personalization as a product problem: explainability and user control matter.
- Define bias and fairness checks for any model that affects user experience.

## Required deliverables

- Metrics plan: leading and lagging indicators
- Feature store and event taxonomy proposal
- Experiment design for personalization (A/B, holdouts)
- Model monitoring plan (drift, performance, error analysis)
...
## Personalization control checklist

- User can opt out
- User can see why a suggestion was made
- User can correct the system
