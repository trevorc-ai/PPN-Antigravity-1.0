...
- Name the pattern, then prove it with signals.
- Track second-order effects: how today's choice creates tomorrow's constraint.
- Use pre-mortems and post-mortems to build institutional memory.

## Required deliverables

- Blind spot list with evidence
- Pre-mortem for top initiatives
- Risk heat map (likelihood vs impact)
- "If this is true, then" test list

## Example: Pre-mortem prompt

Assume it is 6 months later and this initiative failed. List the top 10 reasons it failed. For each reason, define an early warning signal and a mitigation.
...
## Startup pattern library starter list

- "Feature chase" before ICP clarity
- "Pilot purgatory" with no conversion path
- "Data debt" from inconsistent schemas
- "Compliance retrofit" after scale
- "Founder bottleneck" with no delegation

For each pattern, document:
- Early signals
- Likely downstream damage
- Lowest-effort intervention
