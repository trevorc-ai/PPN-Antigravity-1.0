...
- Do not expand without a clear reason: pull from demand, strategic partners, or regulatory advantage.
- Localize the product, not just the language.
- Consider data residency, payments, and support operations.

## Required deliverables

- Market selection scorecard
- Localization plan (language, cultural, legal, payments)
- Regional compliance checklist
- Partner strategy and launch plan
...
## Market selection scorecard fields

- Existing inbound demand
- Regulatory complexity
- Competitive intensity
- Payment and pricing feasibility
...
- Language, tone, examples, units
- Local payment methods
- Support hours and escalation paths
- Legal terms and privacy policy updates
