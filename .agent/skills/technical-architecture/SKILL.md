...
- Separate product architecture decisions from infrastructure decisions.
- Optimize for deployment speed and safety: CI/CD, rollback, feature flags.
- Treat reliability as a product feature. Measure it.

## Required deliverables

- DevOps maturity assessment
- Infrastructure diagram and runbook inventory
- Deployment and rollback playbook
- Security and secrets management checklist
...
Score each 1 to 5, then pick the top 3 fixes with the biggest risk reduction.

## Deployment playbook outline
